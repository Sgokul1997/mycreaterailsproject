...
class MarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post marks_url, params: { mark: { english: @mark.english, maths: @mark.maths, tamil: @mark.tamil } }
    end
  ...
  test "should update mark" do
    patch mark_url(@mark), params: { mark: { english: @mark.english, maths: @mark.maths, tamil: @mark.tamil } }
